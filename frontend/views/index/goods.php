    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=($good->photo)[0]->path."?imageView2/1/w/800/h/800"?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=($good->photo)[0]->path."?imageView2/1/w/350/h/350"?>" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <?php foreach ($good->photo as $k1=>$img):?>
                            <li <?=$k1==0?'class="cur"':''?>>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li><span>上架时间：</span><?=date("Y-m-d H:i:s",$good->createtime_at)?></li>
