...
echo $form->field($model,"rememberMe")->checkbox(['class'=>'deful']);
echo "<hr/>";

echo '<label>&ensp;</label>'.\yii\helpers\Html::submitButton("",['class'=>'login_btn']);
echo "</ul>";
...
*/?>
            <form action="login" method="post">
                <ul>
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="checkbox" class="chb" name="Member[rememberMe]"  /> 保存登录信息
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
